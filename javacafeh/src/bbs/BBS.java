...
public class BBS {
  ...
  private int articleNumber;
	...
	//생성자 (필수입력 )
		public BBS(String bbsnum, String title, String contents, String ref, String re_step,
				Date reg_date, String readcount, String password_yn, String ref_lev, String user_no) {
			super();
			this.bbsnum = bbsnum;
			this.title = title;
	...
	public String toString() {
		return "BBS [articleNumber=" + articleNumber + ", bbsnum=" + bbsnum + ", title=" + title + ", contents="
				+ contents + ", ref=" + ref + ", re_step=" + re_step + ", reg_date=" + reg_date + ", readcount="
				+ readcount + ", password_yn=" + password_yn + ", ref_lev=" + ref_lev + ", user_no=" + user_no + "]";
	}
